...
from .destinations import preserve_fork_options
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    async def async_step_init(self, user_input: dict[str, Any] | None = None):
        ...
        if user_input is not None:
            # Fork : le formulaire ignore les options du fork, on les reporte.
            user_input = preserve_fork_options(self.config_entry.options, user_input)
